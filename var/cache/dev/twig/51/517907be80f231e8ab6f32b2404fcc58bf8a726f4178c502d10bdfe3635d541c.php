...
class __TwigTemplate_f99f28df758da34f5b68122bf52606416f107d91b25a68a8a993ac2df4347e4c extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "Liste des types d'activité";
    ...
    <h1>Liste des types d'activité</h1>
</br></br>
    <table class=\"table\">
        <thead>
            <tr>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["activite"]) {
            ...
            echo "            <tr>
                <td>";
            // line 21
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["activite"], "id", [], "any", false, false, false, 21), "html", null, true);
            echo "</td>
                <td>";
            // line 22
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["activite"], "libelle", [], "any", false, false, false, 22), "html", null, true);
            echo "</td>
                <td>
                    <a href=\"";
            // line 24
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("activite_show", ["id" => twig_get_attribute($this->env, $this->source, $context["activite"], "id", [], "any", false, false, false, 24)]), "html", null, true);
            echo "\">+ de détails</a>
                        ou
                    <a href=\"";
            // line 26
    ...
    <a href=\"";
        ...
        echo "\">Ajouter un type d'activité</a>
    </center>
";
    ...
    {
        return array (  148 => 37,  143 => 34,  134 => 30,  125 => 26,  120 => 24,  115 => 22,  111 => 21,  108 => 20,  103 => 19,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Liste des types d'activité{% endblock %}
...
<center>
    ...
    <table class=\"table\">
        ...
        {% for activite in activites %}
            <tr>
                ...
                <td>
                    <a href=\"{{ path('activite_show', {'id': activite.id}) }}\">+ de détails</a>
                        ou
    ...
    <a href=\"{{ path('activite_new') }}\">Ajouter un type d'activité</a>
    </center>
{% endblock %}
", "activite/index.html.twig", "C:\\Users\\SIO1\\Documents\\Symfony\\TimeTimer1.1\\templates\\activite\\index.html.twig");
    }
}
