...
class __TwigTemplate_0fbd6168658e72b49de2068ba15abba2ab445d5058b3d64358e2b36432e1462f extends Template
{
    private $source;
    private $macros = [];
    ...
    <h1>Modification de l'enfant</h1>
</br></br>
    ";
        // line 10
        echo twig_include($this->env, $context, "enfant/_form.html.twig", ["button_label" => "Modifier"]);
        echo "
    ";
        // line 11
...
<center>
    ...
    {{ include('enfant/_form.html.twig', {'button_label': 'Modifier'}) }}
    {{ include('enfant/_delete_form.html.twig') }}
    </br>
    <a href=\"{{ path('enfant_index') }}\">retourner en arrière</a>
